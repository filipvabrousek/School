...
\begin{figure}[ht!]
\centering
\includegraphics[width=90mm]{"https://gjszlin.bakalari.cz/next/images/LOGIN/login-logo.png"}
...
\section*{Layout in code vs. Storyboard}
...
Ke správnému fungování aplikace bylo potřeba vymyslet algoritmus, který uživatele seřadí dle výkonosti relativně k vám. Proto jsem napsal funkci proximity, která vyžaduje následující argumenty: \hfill \break

$myswim$: můj čas na 1km plavání ve fromátu “mm:ss”
myrun: můj čas na 10km běhu “mm:ss” a   \hfill \break
$hisswim$: čas uživatele na 1km plavání, se kterým se porovnávám  \hfill \break
